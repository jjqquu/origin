...
func deepCopy_v1_DeploymentConfigSpec(in deployapiv1.DeploymentConfigSpec, out *deployapiv1.DeploymentConfigSpec, c *conversion.Cloner) error {
	...
	if in.MarathonAppTemplate != nil {
		...
		if err := deepCopy_v1_MarathonApplication(*in.MarathonAppTemplate, out.MarathonAppTemplate, c); err != nil {
			return err
		}
	} else {
...
func deepCopy_v1_MarathonApplication(in deployapiv1.MarathonApplication, out *deployapiv1.MarathonApplication, c *conversion.Cloner) error {
	out.ID = in.ID
	if in.Cmd != nil {
		out.Cmd = new(string)
		*out.Cmd = *in.Cmd
	...
	if in.Container != nil {
		...
		if err := deepCopy_v1_MarathonContainer(*in.Container, out.Container, c); err != nil {
			return err
		}
	} else {
		out.Container = nil
	...
	if in.HealthChecks != nil {
		if newVal, err := c.DeepCopy(in.HealthChecks); err != nil {
			...
			out.HealthChecks = newVal.(*[]deployapiv1.MarathonHealthCheck)
		}
	} else {
		out.HealthChecks = nil
	}
	...
	if in.UpgradeStrategy != nil {
		...
		if err := deepCopy_v1_MarathonUpgradeStrategy(*in.UpgradeStrategy, out.UpgradeStrategy, c); err != nil {
			return err
		}
	} else {
	...
	if in.Fetch != nil {
		...
		for i := range in.Fetch {
			if err := deepCopy_v1_MarathonFetch(in.Fetch[i], &out.Fetch[i], c); err != nil {
				return err
			}
		}
	} else {
...
func deepCopy_v1_MarathonContainer(in deployapiv1.MarathonContainer, out *deployapiv1.MarathonContainer, c *conversion.Cloner) error {
	out.Type = in.Type
	if in.Docker != nil {
		out.Docker = new(deployapiv1.MarathonDocker)
		if err := deepCopy_v1_MarathonDocker(*in.Docker, out.Docker, c); err != nil {
			return err
		}
	} else {
		out.Docker = nil
	...
	if in.Volumes != nil {
		if newVal, err := c.DeepCopy(in.Volumes); err != nil {
			...
			out.Volumes = newVal.(*[]deployapiv1.MarathonVolume)
		}
	} else {
		out.Volumes = nil
	}
...
func deepCopy_v1_MarathonDocker(in deployapiv1.MarathonDocker, out *deployapiv1.MarathonDocker, c *conversion.Cloner) error {
	...
	if in.Parameters != nil {
		if newVal, err := c.DeepCopy(in.Parameters); err != nil {
			...
			out.Parameters = newVal.(*[]deployapiv1.MarathonParameters)
		}
	} else {
		out.Parameters = nil
	}
	if in.PortMappings != nil {
		if newVal, err := c.DeepCopy(in.PortMappings); err != nil {
			...
			out.PortMappings = newVal.(*[]deployapiv1.MarathonPortMapping)
		}
	} else {
		out.PortMappings = nil
	}
...
func deepCopy_v1_MarathonFetch(in deployapiv1.MarathonFetch, out *deployapiv1.MarathonFetch, c *conversion.Cloner) error {
	out.URI = in.URI
...
func deepCopy_v1_MarathonHealthCheck(in deployapiv1.MarathonHealthCheck, out *deployapiv1.MarathonHealthCheck, c *conversion.Cloner) error {
	if in.Command != nil {
...
func deepCopy_v1_MarathonParameters(in deployapiv1.MarathonParameters, out *deployapiv1.MarathonParameters, c *conversion.Cloner) error {
	out.Key = in.Key
	out.Value = in.Value
	return nil
}

func deepCopy_v1_MarathonPortMapping(in deployapiv1.MarathonPortMapping, out *deployapiv1.MarathonPortMapping, c *conversion.Cloner) error {
...
func deepCopy_v1_MarathonUpgradeStrategy(in deployapiv1.MarathonUpgradeStrategy, out *deployapiv1.MarathonUpgradeStrategy, c *conversion.Cloner) error {
	out.MinimumHealthCapacity = in.MinimumHealthCapacity
	out.MaximumOverCapacity = in.MaximumOverCapacity
	return nil
}

func deepCopy_v1_MarathonVolume(in deployapiv1.MarathonVolume, out *deployapiv1.MarathonVolume, c *conversion.Cloner) error {
...
func deepCopy_v1_Site(in siteapiv1.Site, out *siteapiv1.Site, c *conversion.Cloner) error {
	if newVal, err := c.DeepCopy(in.TypeMeta); err != nil {
		return err
	} else {
		out.TypeMeta = newVal.(unversioned.TypeMeta)
...
func deepCopy_v1_SiteAddress(in siteapiv1.SiteAddress, out *siteapiv1.SiteAddress, c *conversion.Cloner) error {
	out.Url = in.Url
	return nil
}

func deepCopy_v1_SiteList(in siteapiv1.SiteList, out *siteapiv1.SiteList, c *conversion.Cloner) error {
	if newVal, err := c.DeepCopy(in.TypeMeta); err != nil {
		return err
	} else {
		out.TypeMeta = newVal.(unversioned.TypeMeta)
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := deepCopy_v1_Site(in.Items[i], &out.Items[i], c); err != nil {
				return err
			}
		}
	} else {
...
func deepCopy_v1_SiteSpec(in siteapiv1.SiteSpec, out *siteapiv1.SiteSpec, c *conversion.Cloner) error {
	out.Type = in.Type
...
func deepCopy_v1_SiteStatus(in siteapiv1.SiteStatus, out *siteapiv1.SiteStatus, c *conversion.Cloner) error {
	out.Phase = in.Phase
...
func deepCopy_v1_StringSource(in siteapiv1.StringSource, out *siteapiv1.StringSource, c *conversion.Cloner) error {
...
func deepCopy_v1_StringSourceSpec(in siteapiv1.StringSourceSpec, out *siteapiv1.StringSourceSpec, c *conversion.Cloner) error {
	out.Value = in.Value
	out.Env = in.Env
	out.File = in.File
