...
func deepCopy_v1beta3_DeploymentConfigSpec(in deployapiv1beta3.DeploymentConfigSpec, out *deployapiv1beta3.DeploymentConfigSpec, c *conversion.Cloner) error {
	...
	if in.MarathonAppTemplate != nil {
		out.MarathonAppTemplate = new(deployapiv1beta3.MarathonApplication)
		if err := deepCopy_v1beta3_MarathonApplication(*in.MarathonAppTemplate, out.MarathonAppTemplate, c); err != nil {
			return err
		}
	} else {
...
func deepCopy_v1beta3_MarathonApplication(in deployapiv1beta3.MarathonApplication, out *deployapiv1beta3.MarathonApplication, c *conversion.Cloner) error {
	out.ID = in.ID
	if in.Cmd != nil {
		out.Cmd = new(string)
		*out.Cmd = *in.Cmd
	...
	if in.Args != nil {
		if newVal, err := c.DeepCopy(in.Args); err != nil {
			return err
		} else if newVal == nil {
			out.Args = nil
		} else {
			out.Args = newVal.(*[]string)
		}
	} else {
		out.Args = nil
	}
	if in.Constraints != nil {
		if newVal, err := c.DeepCopy(in.Constraints); err != nil {
			return err
		} else if newVal == nil {
			out.Constraints = nil
		} else {
			out.Constraints = newVal.(*[][]string)
		}
	} else {
		out.Constraints = nil
	}
	if in.Container != nil {
		...
		if err := deepCopy_v1beta3_MarathonContainer(*in.Container, out.Container, c); err != nil {
			return err
		}
	} else {
		out.Container = nil
	...
	if in.Env != nil {
		if newVal, err := c.DeepCopy(in.Env); err != nil {
			return err
		} else if newVal == nil {
			out.Env = nil
		} else {
			out.Env = newVal.(*map[string]string)
		}
	} else {
		out.Env = nil
	}
	...
	if in.HealthChecks != nil {
		if newVal, err := c.DeepCopy(in.HealthChecks); err != nil {
			return err
		} else if newVal == nil {
			out.HealthChecks = nil
		} else {
			out.HealthChecks = newVal.(*[]deployapiv1beta3.MarathonHealthCheck)
		}
	} else {
		out.HealthChecks = nil
	}
	...
	if in.UpgradeStrategy != nil {
		...
		if err := deepCopy_v1beta3_MarathonUpgradeStrategy(*in.UpgradeStrategy, out.UpgradeStrategy, c); err != nil {
			return err
		}
	} else {
	...
	if in.Uris != nil {
		if newVal, err := c.DeepCopy(in.Uris); err != nil {
			return err
		} else if newVal == nil {
			out.Uris = nil
		} else {
			out.Uris = newVal.(*[]string)
		}
	} else {
		out.Uris = nil
	}
	if in.Labels != nil {
		if newVal, err := c.DeepCopy(in.Labels); err != nil {
			return err
		} else if newVal == nil {
			out.Labels = nil
		} else {
			out.Labels = newVal.(*map[string]string)
		}
	} else {
		out.Labels = nil
	}
	...
	if in.Fetch != nil {
		...
		for i := range in.Fetch {
			if err := deepCopy_v1beta3_MarathonFetch(in.Fetch[i], &out.Fetch[i], c); err != nil {
				return err
			}
		}
	} else {
...
func deepCopy_v1beta3_MarathonContainer(in deployapiv1beta3.MarathonContainer, out *deployapiv1beta3.MarathonContainer, c *conversion.Cloner) error {
	out.Type = in.Type
	if in.Docker != nil {
		out.Docker = new(deployapiv1beta3.MarathonDocker)
		if err := deepCopy_v1beta3_MarathonDocker(*in.Docker, out.Docker, c); err != nil {
			return err
		}
	} else {
		out.Docker = nil
	...
	if in.Volumes != nil {
		if newVal, err := c.DeepCopy(in.Volumes); err != nil {
			return err
		} else if newVal == nil {
			out.Volumes = nil
		} else {
			out.Volumes = newVal.(*[]deployapiv1beta3.MarathonVolume)
		}
	} else {
		out.Volumes = nil
	}
...
func deepCopy_v1beta3_MarathonDocker(in deployapiv1beta3.MarathonDocker, out *deployapiv1beta3.MarathonDocker, c *conversion.Cloner) error {
	...
	if in.Parameters != nil {
		if newVal, err := c.DeepCopy(in.Parameters); err != nil {
			...
			out.Parameters = newVal.(*[]deployapiv1beta3.MarathonParameters)
		}
	} else {
		out.Parameters = nil
	}
	if in.PortMappings != nil {
		if newVal, err := c.DeepCopy(in.PortMappings); err != nil {
			return err
		} else if newVal == nil {
			out.PortMappings = nil
		} else {
			out.PortMappings = newVal.(*[]deployapiv1beta3.MarathonPortMapping)
		}
	} else {
		out.PortMappings = nil
	}
...
func deepCopy_v1beta3_MarathonFetch(in deployapiv1beta3.MarathonFetch, out *deployapiv1beta3.MarathonFetch, c *conversion.Cloner) error {
	out.URI = in.URI
...
func deepCopy_v1beta3_MarathonHealthCheck(in deployapiv1beta3.MarathonHealthCheck, out *deployapiv1beta3.MarathonHealthCheck, c *conversion.Cloner) error {
	if in.Command != nil {
...
func deepCopy_v1beta3_MarathonParameters(in deployapiv1beta3.MarathonParameters, out *deployapiv1beta3.MarathonParameters, c *conversion.Cloner) error {
	out.Key = in.Key
	out.Value = in.Value
	return nil
}

func deepCopy_v1beta3_MarathonPortMapping(in deployapiv1beta3.MarathonPortMapping, out *deployapiv1beta3.MarathonPortMapping, c *conversion.Cloner) error {
...
func deepCopy_v1beta3_MarathonUpgradeStrategy(in deployapiv1beta3.MarathonUpgradeStrategy, out *deployapiv1beta3.MarathonUpgradeStrategy, c *conversion.Cloner) error {
	out.MinimumHealthCapacity = in.MinimumHealthCapacity
	out.MaximumOverCapacity = in.MaximumOverCapacity
	return nil
}

func deepCopy_v1beta3_MarathonVolume(in deployapiv1beta3.MarathonVolume, out *deployapiv1beta3.MarathonVolume, c *conversion.Cloner) error {
...
func deepCopy_v1beta3_Site(in siteapiv1beta3.Site, out *siteapiv1beta3.Site, c *conversion.Cloner) error {
	if newVal, err := c.DeepCopy(in.TypeMeta); err != nil {
		return err
	} else {
		out.TypeMeta = newVal.(unversioned.TypeMeta)
	...
	if err := deepCopy_v1beta3_SiteSpec(in.Spec, &out.Spec, c); err != nil {
		return err
	}
	if err := deepCopy_v1beta3_SiteStatus(in.Status, &out.Status, c); err != nil {
		return err
	}
	return nil
}

func deepCopy_v1beta3_SiteAddress(in siteapiv1beta3.SiteAddress, out *siteapiv1beta3.SiteAddress, c *conversion.Cloner) error {
	out.Url = in.Url
	return nil
}

func deepCopy_v1beta3_SiteList(in siteapiv1beta3.SiteList, out *siteapiv1beta3.SiteList, c *conversion.Cloner) error {
	if newVal, err := c.DeepCopy(in.TypeMeta); err != nil {
		return err
	} else {
		out.TypeMeta = newVal.(unversioned.TypeMeta)
	...
	if in.Items != nil {
		...
		for i := range in.Items {
			if err := deepCopy_v1beta3_Site(in.Items[i], &out.Items[i], c); err != nil {
				return err
			}
		}
	} else {
...
func deepCopy_v1beta3_SiteSpec(in siteapiv1beta3.SiteSpec, out *siteapiv1beta3.SiteSpec, c *conversion.Cloner) error {
	out.Type = in.Type
	if err := deepCopy_v1beta3_SiteAddress(in.Address, &out.Address, c); err != nil {
		return err
	}
	if err := deepCopy_v1beta3_StringSource(in.Credential, &out.Credential, c); err != nil {
		return err
	}
	if in.Finalizers != nil {
		out.Finalizers = make([]pkgapiv1beta3.FinalizerName, len(in.Finalizers))
...
func deepCopy_v1beta3_SiteStatus(in siteapiv1beta3.SiteStatus, out *siteapiv1beta3.SiteStatus, c *conversion.Cloner) error {
	out.Phase = in.Phase
...
func deepCopy_v1beta3_StringSource(in siteapiv1beta3.StringSource, out *siteapiv1beta3.StringSource, c *conversion.Cloner) error {
	if err := deepCopy_v1beta3_StringSourceSpec(in.StringSourceSpec, &out.StringSourceSpec, c); err != nil {
		return err
	}
	return nil
}

func deepCopy_v1beta3_StringSourceSpec(in siteapiv1beta3.StringSourceSpec, out *siteapiv1beta3.StringSourceSpec, c *conversion.Cloner) error {
	out.Value = in.Value
	out.Env = in.Env
	out.File = in.File
...
func init() {
	err := api.Scheme.AddGeneratedDeepCopyFuncs(
		...
		deepCopy_v1beta3_MarathonApplication,
		deepCopy_v1beta3_MarathonContainer,
		deepCopy_v1beta3_MarathonDocker,
		deepCopy_v1beta3_MarathonFetch,
		deepCopy_v1beta3_MarathonHealthCheck,
		deepCopy_v1beta3_MarathonParameters,
		deepCopy_v1beta3_MarathonPortMapping,
		deepCopy_v1beta3_MarathonUpgradeStrategy,
		deepCopy_v1beta3_MarathonVolume,
		...
		deepCopy_v1beta3_Site,
		deepCopy_v1beta3_SiteAddress,
		deepCopy_v1beta3_SiteList,
		deepCopy_v1beta3_SiteSpec,
		deepCopy_v1beta3_SiteStatus,
		deepCopy_v1beta3_StringSource,
		deepCopy_v1beta3_StringSourceSpec,
