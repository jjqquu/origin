...
func (d *Deployment) execute() error {
	...
	var hasDesired bool
	d.desiredReplicas, hasDesired = deployutil.DeploymentDesiredReplicas(d.to)
	if !hasDesired {
...
func convertToMarathonApplication(app *deployapi.MarathonApplication) *marathon.Application {
	...
	result.Constraints = app.Constraints
